...
const loginSupport = async (user) =>
  new Promise((resolve, reject) => {
    let sql = `select Id, Account, Name, BirthDay, Gender, PhoneNumber, isManager, isDriver,RouteResgisterId from user where Account = ? and Password = ?`;
    db.query(sql, [user.userName, user.password], (err, response) => {
      if (err) throw err;
